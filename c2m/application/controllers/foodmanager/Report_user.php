...
public function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('foodmanager/store_user_owner_model');
        $this->load->model('foodmanager/store_reportuser_model');
	...
	public function index()
	{
		...
		$this->foodmanagerlayout('foodmanager/report_user',$data);
	}
