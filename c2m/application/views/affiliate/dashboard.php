...
<h3>
<span style="color: red;font-weight: bold;"> <?php echo number_format($get_num_aff_income_withdrawal); ?> </span> บาท
<br />
ยอดเงินที่ถอนได้   </h3>
</div>
...
<div class="col-md-3 panel panel-body panel-default text-center">
<h3><?php echo number_format($get_num_aff_income_all); ?> บาท 
<br />  รายได้รวม </h3>
</div>
...
<div class="col-md-3 panel panel-body panel-default text-center">
<h3>
  <?php echo number_format($get_num_owner_status_yes); ?> คน
  <br /> 
...
<div class="col-md-3 panel panel-body panel-default text-center">
<h3>
<?php echo number_format($get_num_owner_all); ?> คน
<br /> 
ผู้สมัครทั้งหมด 
