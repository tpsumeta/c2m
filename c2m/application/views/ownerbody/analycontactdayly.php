...
<center><font size="4"><span class="glyphicon glyphicon-signal" aria-hidden="true"></span> สถิติการติดต่อ  </font></center>
...
<table class="table table-hover table-responsive">
	<thead>
		<tr style="background-color: #eee;">
			...
			<th class="text-center" colspan="2">ดาวน์โหลดรายการติดต่อ</th>
		</tr>
	</thead>
	<tbody>
...
<div class="form-group">
<button class="btn btn-info"  ng-click="DownloadExcelm()" title="ดาวน์โหลดรายการติดต่อ" ><span class="glyphicon glyphicon-save" aria-hidden="true"></button> 
</div>
</form>
