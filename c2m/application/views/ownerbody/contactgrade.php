...
<font size="4"><span class="glyphicon glyphicon-th" aria-hidden="true"></span>เกรด/คะแนนการติดต่อ  <a class="btn btn-primary"  style="float: right" ng-click="Openaddnewcus()"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a></font>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">เพิ่มเกรด/คะแนนการติดต่อใหม่</h4>
			</div>
...
<div class="row">
<div class="col-md-12">
	<input type="text" placeholder="ชื่อเกรด/คะแนนการติดต่อ" name="" class="form-control" ng-model="contact_grade_name" required>
...
<div class="col-md-12">
	<textarea name="" class="form-control" placeholder="หมายเหตุ" ng-model="contact_grade_remark">
</textarea> 
</div>
...
<button type="submit" class="btn btn-success" id="savenewcontact" ng-click="SaveSubmit(contact_grade_name,contact_grade_remark)">บันทึก</button>
			</div>
		</div>
...
<div class="modal fade" id="modaledit">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">แก้ไข เกรด/คะแนนการติดต่อ</h4>
			</div>
			<div class="modal-body">
...
<div class="col-md-12">
	<textarea name="" class="form-control" placeholder="หมายเหตุ" ng-model="contact_grade_remark">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">ปิด</button>
<button type="submit" class="btn btn-success" id="editcontact" ng-click="EditSubmit(contact_grade_id,contact_grade_name,contact_grade_remark)">บันทึก</button>
			</div>
		</div>
