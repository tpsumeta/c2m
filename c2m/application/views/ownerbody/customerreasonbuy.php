...
<font size="4"><span class="glyphicon glyphicon-th" aria-hidden="true"></span>เหตุผลที่ซื้อ  <a class="btn btn-primary"  style="float: right" ng-click="Openaddnewcus()"><span class="glyphicon glyphicon-plus" aria-hidden="true"></a></font>
...
<div class="row">
<div class="col-md-12">
	<input type="text" placeholder="ชื่อเหตุผล" name="" class="form-control" ng-model="customer_reasonbuy_name" required>
...
<div class="col-md-12">
	<textarea name="" class="form-control" placeholder="หมายเหตุ" ng-model="customer_reasonbuy_remark">
</textarea> 
</div>
...
<button type="submit" class="btn btn-success" id="savenewcustomer" ng-click="SaveSubmit(customer_reasonbuy_name,customer_reasonbuy_remark)">บันทึก</button>
			</div>
		</div>
...
<div class="col-md-12">
	<textarea name="" class="form-control" placeholder="หมายเหตุ" ng-model="customer_reasonbuy_remark">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">ปิด</button>
<button type="submit" class="btn btn-success" id="editcustomer" ng-click="EditSubmit(customer_reasonbuy_id,customer_reasonbuy_name,customer_reasonbuy_remark)">บันทึก</button>
			</div>
		</div>
